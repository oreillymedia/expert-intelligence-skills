...
Candidate SLIs and SLOs sized to what the service actually does and who depends on it, plus an
error-budget policy that says what happens when the budget burns — grounded in how SRE practitioners
describe setting these, not in round numbers.
...
4. Install **Reliability Plan** from the list.
...
/plugin install plan-service-reliability@expert-intelligence-skills
```
...
codex plugin add plan-service-reliability@expert-intelligence-skills
```
...
Download
[SKILL.md](https://github.com/oreillymedia/expert-intelligence-skills/blob/main/plugins/plan-service-reliability/skills/plan-service-reliability/SKILL.md)
...
- **Claude Code or Codex CLI:** save it, filename unchanged, as `plan-service-reliability/SKILL.md` inside
...
field in `skills/plan-service-reliability/SKILL.md` for the full set of trigger conditions.
