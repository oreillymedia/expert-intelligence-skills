...
A learning path across books, video, and live events that says why each item comes when it does —
the sequencing is the value a reading list doesn't give you. Paced to the hours you actually have,
with behavioral markers for whether it's working.
...
4. Install **Learning Plan** from the list.
...
/plugin install create-learning-plan@expert-intelligence-skills
```
...
codex plugin add create-learning-plan@expert-intelligence-skills
```
...
Download
[SKILL.md](https://github.com/oreillymedia/expert-intelligence-skills/blob/main/plugins/create-learning-plan/skills/create-learning-plan/SKILL.md)
...
- **Claude Code or Codex CLI:** save it, filename unchanged, as `create-learning-plan/SKILL.md` inside
...
`description` field in `skills/create-learning-plan/SKILL.md` for the full set of trigger conditions.
