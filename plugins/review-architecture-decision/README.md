...
A review of your design that names the trade-offs you've implicitly accepted, checks them against
how practitioners describe the same decisions, and flags the ones that tend to bite later. Credits
what's sound instead of manufacturing objections.
...
4. Install **Architecture Decision Review** from the list.
...
/plugin install review-architecture-decision@expert-intelligence-skills
```
...
codex plugin add review-architecture-decision@expert-intelligence-skills
```
...
Download
[SKILL.md](https://github.com/oreillymedia/expert-intelligence-skills/blob/main/plugins/review-architecture-decision/skills/review-architecture-decision/SKILL.md)
...
- **Claude Code or Codex CLI:** save it, filename unchanged, as `review-architecture-decision/SKILL.md` inside
...
`description` field in `skills/review-architecture-decision/SKILL.md` for the full set of trigger conditions.
