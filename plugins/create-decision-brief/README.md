...
A half-page brief that leads with the recommendation, then lays out where experts agree, where they
disagree, the failure modes teams at your scale hit, what has to be true first, and what evidence
would flip the call. Scannable in under two minutes and forwardable to a board or a skeptical peer.
...
4. Install **Decision Brief** from the list.
...
/plugin install create-decision-brief@expert-intelligence-skills
```
...
codex plugin add create-decision-brief@expert-intelligence-skills
```
...
Download
[SKILL.md](https://github.com/oreillymedia/expert-intelligence-skills/blob/main/plugins/create-decision-brief/skills/create-decision-brief/SKILL.md)
...
- **Claude Code or Codex CLI:** save it, filename unchanged, as `create-decision-brief/SKILL.md` inside
...
`description` field in `skills/create-decision-brief/SKILL.md` for the full set of trigger conditions.
