...
A deployment plan matched to what your team can actually operate today — a team with no MLOps
practice gets different advice than one with a platform — covering rollout shape, monitoring, and
the failure modes that show up at that maturity level.
...
4. Install **Production Ready AI** from the list.
...
/plugin install plan-production-ready-ai@expert-intelligence-skills
```
...
codex plugin add plan-production-ready-ai@expert-intelligence-skills
```
...
Download
[SKILL.md](https://github.com/oreillymedia/expert-intelligence-skills/blob/main/plugins/plan-production-ready-ai/skills/plan-production-ready-ai/SKILL.md)
...
- **Claude Code or Codex CLI:** save it, filename unchanged, as `plan-production-ready-ai/SKILL.md` inside
...
`description` field in `skills/plan-production-ready-ai/SKILL.md` for the full set of trigger conditions.
